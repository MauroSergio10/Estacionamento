    ...
    return (
        <div className="flex flex-col h-screen justify-center items-center px-4">
            <div className="flex flex-col justify-center items-center bg-gray-800 w-full md:w-2/3 lg:w-1/2 xl:w-1/3 py-12 rounded-xl space-y-8 shadow-br shadow-2xl shadow-indigo-900 px-4">
                ...
                <button className="font-bold text-lg border-2 border-indigo-700 bg-indigo-700 text-white h-12 md:h-16 w-full md:w-64 lg:w-72 rounded-full hover:text-indigo-700 hover:bg-transparent transition-all duration-300 ease-in-out" onClick={() => navigate('/Pagamento')}>Pesquisar</button>
            </div>
        </div>
    );
}
